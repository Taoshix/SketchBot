        ...
        public async Task Eval([Remainder] string code)
        {
            ...
            using (Context.Channel.EnterTypingState())
            {
                try
                {
                    ...
                    var emoji = new Emoji("✅");
                    Globals globals = new Globals { Context = Context, Guild = Context.Guild, DblApi = _service.DblApi(), ServiceProvider = _serviceProvider, LavaNode = _lavaNode, CachingService = _cachingService};
